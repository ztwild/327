...
{
  if(atk != d->PC && def != d->PC) return; 
  int can_see_atk, can_see_def;
  const char *organs[] = {
    "liver",  "pancreas",   "heart",  "eye",  "arm",   
    "leg",    "intestines", "gall bladder",   "lungs",  "hand", 
    "foot",   "spinal cord",  "pituitary gland",  "thyroid", 
    "tongue", "bladder",    "diaphram", "stomach",  "pharynx",
    "esophagus",  "trachea",  "urethra",  "spleen", "ganglia",
